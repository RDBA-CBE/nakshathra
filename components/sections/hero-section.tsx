...
export default function HeroSection() {
  ...
  return (
    <section className="relative h-[600px] bg-[#F5F1ED] overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-0 h-full">
          ...
          <div className="flex items-center px-12 lg:px-16">
            <div key={`text-${currentSlide}`} className="animate-fade-in-up">
              ...
              <h1 className="font-serif text-4xl lg:text-5xl xl:text-6xl text-[#2C1810] mb-6 leading-tight text-balance">
                {currentSlideData.title}
              </h1>
              <p className="text-[#4A5568] mb-8 leading-relaxed max-w-lg text-sm">{currentSlideData.description}</p>
          ...
          <div className="relative h-full">
            <div key={`image-${currentSlide}`} className="absolute inset-0 animate-fade-in">
              <img
