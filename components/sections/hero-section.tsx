      ...
      <div className="w-full flex flex-col lg:flex-row items-stretch relative">
        ...
        <div className="w-full lg:w-1/2 px-6 md:px-12 lg:pl-20 relative z-10 flex items-center">
          <div className="max-w-[720px] py-12 lg:py-28">
            <p className="uppercase tracking-widest text-xl font-heading font-bold text-[#B88A33] mb-4">
              {slide.subtitle}
            </p>

            <h1 className="font-heading text-[#12303a] text-4xl sm:text-5xl md:text-6xl lg:text-[84px] leading-[0.95] mb-6">
              Experience Comfort
              <br />
              Of The City's Stays
            </h1>
