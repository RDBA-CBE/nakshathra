            ...
            <div className="space-y-12">
              ...
              <section className="space-y-4 pt-8 border-t border-gray-200">
                ...
                <p className="para">
                  ...
                  liability. Nakshathra Royal Stay and / or its associate
              ...
              <section className="space-y-4 pt-8 border-t border-gray-200">
                ...
                <p className="para">
                  ...
                  / or its associate entities, Nakshathra Royal Stay is not
                  ...
                  other relationship between Nakshathra Royal Stay website and
                ...
                <p className="para">
                  ...
                  knowledge of Nakshathra Royal Stay and / or its associate
              ...
              <section className="space-y-4 pt-8 border-t border-gray-200">
                ...
                <p className="para">
                  ...
                  will Nakshathra Royal Stay or anyone else involved in
                  providing the service be liable for any direct, indirect,
                  incidental, special or consequential damages or losses from or
                  through the use of or inability to use the service or that
                  result from mistakes, omissions, interruptions, delays in
